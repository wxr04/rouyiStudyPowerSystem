        ...
        <el-row :gutter="10" class="mb8">
         ...
         <!-- <el-col :span="1.5">
            <el-button
              ...
              :disabled="single"
              @click="handleUpdate"
              v-hasPermi="['analysis:energyMonth:edit']"
            >修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['analysis:energyMonth:remove']"
            >删除</el-button>
          </el-col>-->
          <el-col :span="1.5">
            <el-button
  ...
  methods: {
    ...
    * */
    ...
    getList() {
      ...
      listEnergyMonth(searchParams).then(response => {
    ...
    setParams(params,selectDevs){
      ...
      //console.log(selectDevs);
      if(selectDevs.length==0)
        alert('没有选择设备！');
      search.params['devIds']=selectDevs;

      search.params["time"]=params.collectTime;
     // search.put("collectTime",this.queryTime);
      search.queryTime=this.queryTime;
     // console.log(search.params.selectDevs);
